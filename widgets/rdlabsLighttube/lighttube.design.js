function twxLighttube() {
 ...
 isBindingTarget: false,
    ...
    runtimeTemplate: function (props, twxWidgetEl, fullOriginalDoc, $, projectSettings) {
      ...
      var ctrl= '<div ng-lighttube id="'+props.widgetId+'" isholo-field='+isholo+' nstrips-field={{me.nstrips}} wstrip-field={{me.wstrip}} intensity-field={{me.intensity}} disable-field={{me.disable}} affects={{me.affects}}></div>';
