function twxFogger() {
 ...
 isBindingTarget: true,
    ...
    runtimeTemplate: function (props) {
      ...
      var tmpl = '<twx-dt-3dobject id="'+props.widgetId+'" hidden={{me.disabled}} shader="circle;radius f {{me.radius}}" vertices="[-0.95,-0.95,1, 0.95,-0.95,1, 0.95,0.95,1, -0.95,0.95,1]" normals="[]" indexes="[0,1,2,0,2,3]" color="{{me.color}}"></twx-dt-3dmodel>';
      return vs+ps+tmpl;
    }
  }
}
