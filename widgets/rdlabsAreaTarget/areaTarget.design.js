...
(function(twxAppBuilder){
 ...
 allowedPatterns: ['.glb'],
    ...
    runtimeTemplate: function (props) {
                       ...
                       var occluder = '<twx-dt-model id="'+props.widgetId+'-occluder" src="{{me.occluder}}" occlude="true" opacity="1" hidden="{{!me.occlude}}" decal="false" sx="1" sy="1" sz="1" x="0" y="0" z="0" rx="0" ry="0" rz="0"></twx-dt-model>';
