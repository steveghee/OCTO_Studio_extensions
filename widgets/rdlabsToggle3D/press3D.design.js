function twxPress3D() {
  return {
    elementTag: 'twx-press3d',
      
    label    : '3D Press Button',
 ...
 isBindingTarget: true,
    ...
    dependencies: {
      files         : ['js/press3D-ng.js', 'images/**'],
      angularModules: ['press3D-ng']
    },
    ...
    runtimeTemplate: function (props, twxWidgetEl, fullOriginalDoc, $, projectSettings) {
      ...
      var tmpl = '<div ng-press3d class="ng-hide toggle3DWidget ' + props.class + '" id-field="' + props.widgetId + '" isholo-field='+forholo+' height-field={{me.height}} width-field={{me.width}}  backer-field={{me.showbacker}} font-field="{{me.fontColor.endsWith(&apos;;&apos;)? me.fontColor.slice(0, -1): me.fontColor}}" text-field={{me.text}} src-field={{me.src}} disabled-field={{me.disabled}}></div>';
...
twxAppBuilder.widget('twxPress3D', twxPress3D);
