function twxPress3D() {
 ...
 isBindingTarget: true,
    ...
    runtimeTemplate: function (props, twxWidgetEl, fullOriginalDoc, $, projectSettings) {
      ...
      var tmpl = '<div ng-press3d id-field="' + props.widgetId + '" isholo-field='+forholo+' height-field={{me.height}} width-field={{me.width}}  backer-field={{me.showbacker}} font-field="{{me.fontColor.endsWith(&apos;;&apos;)? me.fontColor.slice(0, -1): me.fontColor}}" text-field={{me.text}} src-field={{me.src}} disabled-field={{me.disabled}}></div>\n';
