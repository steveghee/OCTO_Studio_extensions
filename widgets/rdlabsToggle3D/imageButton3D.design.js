function twxImageButton3D() {
 ...
 isBindingTarget: true,
    ...
    dependencies: {
      files         : ['js/image3D-ng.js', 'images/**'],
      angularModules: ['image3D-ng']
    },
    ...
    runtimeTemplate: function (props, twxWidgetEl, fullOriginalDoc, $, projectSettings) {
      ...
      var ctrl = '<twx-dt-3dbutton id="' + props.widgetId + '" class="ng-hide image3dWidget ' + props.class + 
...
twxAppBuilder.widget('twxImageButton3D', twxImageButton3D);
