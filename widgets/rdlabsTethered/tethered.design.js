function twxTethered() {
 ...
 isBindingTarget: true
    ...
    runtimeTemplate: function (props, twxWidgetEl, fullOriginalDoc, $, projectSettings) {
      ...
      var ctrl = '<div ng-tethered id-field="' + props.widgetId + '" isholo-field='+forholo+' step-field={{me.steps}} shader-field="me.shader" offset-field={{me.offset}} visible-field={{me.visible}} auto-field={{me.following}} snap-field={{me.snap}} affects-field={{me.affects}} width-field={{me.width}} height-field={{me.height}} delegate-field="delegate"></div>';
      ...
      var tmpl =  '<twx-dt-model id="' + props.widgetId + '" class="tetheredWidget" ' +
