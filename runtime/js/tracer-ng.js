if (typeof module !== 'undefined' && typeof exports !== 'undefined' && module.exports === exports) {
  module.exports = 'tracer-ng';
}

(function () {
  'use strict';

  var tracerModule = angular.module('tracer-ng', []);
  tracerModule.directive('ngtracer', ['$interval', ngtracer]);

  function ngtracer($interval) {
    ...
    return {
      ...
      link: function (scope, element, attr) {
        ...
        scope.$watch('freqField', function () {
